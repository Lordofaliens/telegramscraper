export const cryptoKeywords = [
    ...
    'ico', 'nft', 'stablecoin', 'staking', 'hodl', 'pump', 'dump', 'shitcoin', 'airdrop', 'satoshi', 'liquidity',
    'btc', 'eth', 'metamask', 'dex', 'binance', 'bnb', 'sol', 'xrp', 'doge',
    'moon', 'metaverse', 'lambo', 'sushiswap', 'polygon', 'btc', 'eth', 'xrp', 'ltc', 'bnb', 'sol', 'dot', 'doge',

    // Russian
    'биткоин', 'эфириум', 'криптовалюта', 'стейкинг', 'биток', 'шиткоин', 'метамаск', 'блокчейн', 'памп',
    'шиба ину', 'кардано', 'солана', 'полкадот', 'догикоин', 'шиткоин', 'криптовалюты', 'ходл', 'иксы', 'терра',
...
export const tradingKeywords = [
    ...
    // Russian
    'сигнал', 'трейд', 'форекс', 'леверидж', 'шорт', 'лонг', 'стоп', 'скальп', 'анализ', 'фундаментал',
    'бык', 'медве', 'свеч', 'рынок', 'ран', 'объем', 'тренд', 'икс',

    // Ukrainian
    'сигнал', 'трейд', 'форекс', 'важіль', 'шорт', 'лонг', 'стоп', 'скальп', 'аналіз', 'фундаментал',
    'бик', 'ведмідь', 'свіч', 'ринок', 'обсяг', 'тренд', 'ікс'
];
